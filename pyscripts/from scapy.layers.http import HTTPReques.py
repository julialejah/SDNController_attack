...
def generate_ssh_traffic(tiempo_deseadofuncion):
    ...
    while time.time() - tiempo_iniciofuncion < tiempo_deseadofuncion:
        ...
        sshcx = RandIP()._fix()
        ssh.connect(sshcx, username='root', password='123')
        #-------------------------------------------------------------------------------------------------------------------------------
        # tiempo de espera
...
def generate_traffic():
    ...
    if traffic_type == 1:
        ...
        print("SSH")
        generate_ssh_traffic(traffic_time)
...
if __name__ == "__main__":
    traffic_interval = random.randint(0, 50)  # tiempo entre cada generación de tráfico, en segundos
